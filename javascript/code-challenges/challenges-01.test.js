...
const addOne = (arr) => {
  ...
  numArr.forEach( (value) => newArr.push( value + 1) );
...
const addExclamation = (arr) => {
  let wordArr = ['hi','how','are','you'];
  let newArr = [];

  wordArr.forEach( (value) => newArr.push( value + '!') );
...
const allUpperCase = (arr) => {
  ...
  wordArr.forEach( (value) => newArr.push( value.toUpperCase()) );
